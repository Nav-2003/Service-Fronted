...
import {User,Phone,Mail,Briefcase,IdCard,Lock,Eye,EyeOff} from "lucide-react";
  ...
  try {
    ...
    const response = await fetch(
      `${Api}/api/workerAuth/signUp`,
      {
        ...
        body: JSON.stringify({name,phone,email,service,aadhar,pass:password,lat,lng})
      }
    );
  ...
  return (
    <div
      className="min-h-screen flex items-center justify-center
                    bg-gradient-to-br from-emerald-50 via-white to-teal-50 px-4"
    >
      <motion.div
        ...
        className="w-full max-w-md
                   ...
                   rounded-3xl shadow-[0_30px_80px_rgba(0,0,0,0.15)]
                   p-8"
      >
        {/* HEADER */}
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            className="
              w-full mt-6 py-4 text-lg font-semibold text-white
              rounded-2xl
              bg-gradient-to-r from-emerald-500 via-green-500 to-teal-500
              shadow-[0_20px_40px_rgba(16,185,129,0.35)]
              hover:shadow-[0_30px_60px_rgba(16,185,129,0.45)]
